/*
  # Enhance Conversation Minutes Management
  
  1. Changes
    - Remove the handle_subscription_update function and its trigger
    - Add a new function to calculate carried over minutes
    - Update the webhook_logs table to include more detailed information
    
  2. Purpose
    - Centralize minute management in the Edge Function
    - Support carrying over unused minutes from previous subscription periods
    - Ensure used_conversation_minutes is reset to zero on renewal
    - Improve debugging capabilities for subscription events
*/
