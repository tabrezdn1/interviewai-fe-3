/*
  ...
  1. Clear existing data safely (handling foreign key constraints)
  2. Populate interview_types with screening, technical, behavioral
  3. Populate experience_levels with entry, mid, senior
  4. Populate difficulty_levels with easy, medium, hard
  5. Add sample questions for each interview type
*/
