/*
  # Fix Tavus API Functions
  
  1. Changes
    - Ensure pg_net extension is enabled
    - Drop conflicting function definitions
    - Create a single create_tavus_conversation function with jsonb parameter
    - Fix end_tavus_conversation and delete_tavus_persona functions
    
  2. Purpose
    - Resolve function conflicts causing "http_header function does not exist" errors
    - Ensure consistent function signatures for frontend calls
    - Fix parameter types to match what the frontend is sending
*/
