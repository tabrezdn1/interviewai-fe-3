    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
        <div className="relative">
          ...
          <div className="absolute inset-0 rounded-full border-2 border-blue-600/20 dark:border-blue-400/20"></div>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black overflow-hidden">
      ...
      <div className="fixed top-6 right-6 z-50">
        ...
        >
          {!scrolled && (
            <>
              <div className="absolute inset-0 -z-20 rounded-full blur-3xl opacity-80 w-[120%] h-[120%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-blue-400 via-purple-500 to-purple-700 dark:from-blue-400 dark:via-purple-700 dark:to-purple-900 animate-pulse" />
              <div className="absolute inset-0 -z-10 rounded-full blur-2xl opacity-100 w-full h-full bg-gradient-to-br from-blue-500 via-purple-500 to-purple-600 dark:from-blue-400 dark:via-purple-600 dark:to-purple-800 animate-pulse" />
            </>
          )}
          <div className={cn(
            "relative rounded-full p-2 shadow-lg border transition-all duration-300 hover:shadow-xl hover:scale-105 backdrop-blur-md",
            "bg-white/80 dark:bg-slate-800/80 border-white/20 dark:border-slate-700/50"
          )}>
            <img 
          ...
          <div className="absolute left-1/2 -bottom-14 md:-bottom-12 transform -translate-x-1/2 md:left-auto md:right-0 md:translate-x-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none w-max max-w-xs">
            <div className="bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 text-xs px-3 py-1 rounded-lg border border-white/20 dark:border-slate-700/50 shadow-lg break-words max-w-xs relative">
              Powered by Bolt.new
              <div className="hidden md:block absolute -top-1 right-6 w-2 h-2 bg-white dark:bg-slate-800 border-l border-t border-white/20 dark:border-slate-700/50 rotate-45"></div>
              <div className="block md:hidden absolute -top-2 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-white dark:bg-slate-800 border-l border-t border-white/20 dark:border-slate-700/50 rotate-45"></div>
            </div>
          </div>
        </a>
      </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 dark:from-blue-400/20 dark:to-purple-400/20 backdrop-blur-sm border border-blue-500/30 dark:border-blue-400/30 mb-8"
              >
                <motion.div
                ...
                <span className="text-blue-700 dark:text-blue-300 font-medium">AI-Powered Interview Platform</span>
              </motion.div>
              ...
              >
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button asChild size="lg" className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-xl hover:shadow-2xl transition-all duration-300 border-0 text-lg px-8 py-4 rounded-xl">
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button asChild variant="outline" size="lg" className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-white/20 dark:border-slate-700/50 text-slate-700 dark:text-slate-200 hover:bg-white dark:hover:bg-slate-800 text-lg px-8 py-4 rounded-xl shadow-xl">
                    <a href="#demo">
              ...
              <motion.div
                ...
                className="mt-12"
              >
                <h3 className="text-center text-lg font-semibold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-indigo-400 bg-clip-text text-transparent">
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-10 w-20 h-20 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-xl"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 5, repeat: Infinity }}
          className="absolute bottom-1/4 right-10 w-32 h-32 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-full blur-xl"
        />
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300">
      ...
      <section id="demo" className="py-32 relative">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
              <div className="aspect-video bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 flex items-center justify-center">
                <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-lg px-8 py-4 rounded-xl shadow-xl">
